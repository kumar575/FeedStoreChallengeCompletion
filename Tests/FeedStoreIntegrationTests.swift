...
class FeedStoreIntegrationTests: XCTestCase {
	...
	private func testSpecificStoreURL() -> URL {
		//.cachesDirectory.appendingPathComponent("FeedStore.store")
		//.cachesDirectory.appendingPathComponent("FeedStore.store")
		//.documentsDirectory.appendingPathExtension("FeedStore.store")
		FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first!.appendingPathComponent("FeedStore.store")
	}
}
